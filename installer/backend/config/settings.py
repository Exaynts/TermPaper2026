...
# База данных — SQLite (портативный режим)
DATABASES = {
    'default': {
...
# Email settings (SMTP) — опционально
EMAIL_HOST_USER = os.getenv('EMAIL_HOST_USER', '').strip()
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD', '').strip()

if EMAIL_HOST_USER and EMAIL_HOST_PASSWORD:
    # Если email настроен — используем SMTP
    ...
    # Если не настроен — письма выводятся в консоль
    EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'
    DEFAULT_FROM_EMAIL = 'noreply@mathjam.local'

# Хранилище статики (без manifest — чтобы не падать на отсутствующих шрифтах)
STORAGES = {
    "default": {
